...
const defaultItems = [
  {
    image: '/images/bonj-hero-plate.webp',
    link: '/menu',
    title: 'Bonj seçkisi',
    description: 'Günün tatlarını keşfet.'
  }
];
...
export default function InfiniteMenu({ items = [], scale = 1.0 }) {
  ...
  useEffect(() => {
    ...
    const renderItems = items.length ? items : defaultItems;
  ...
  return (
    <div className="bonj-infinite-menu">
      <canvas id="infinite-grid-menu-canvas" ref={canvasRef} />

      {!webGlAvailable && <p className="infinite-menu-fallback">Etkileşimli menü bu cihazda desteklenmiyor. Ürünleri görmek için menüyü açabilirsin.</p>}
